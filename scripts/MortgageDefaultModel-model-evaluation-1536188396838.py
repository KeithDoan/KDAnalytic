...
model_path = os.getenv("DSX_PROJECT_DIR") + "/models/MortgageDefault_Model/2/model"
...
evaluations_file_path = os.getenv("DSX_PROJECT_DIR") + '/models/' + "MortgageDefault_Model" + '/' + "2" + '/evaluations.json'
